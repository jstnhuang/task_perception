...
Eigen::Vector3d Pr2GripperModel::forward_palm_center() const {
  tg::Position palm_center;
  tf_graph_.DescribePosition(tg::Position(kPalmDims.x / 2, 0, 0),
                             tg::Source("palm"), tg::Target("gripper base"),
                             &palm_center);
  return palm_center.vector();
}
